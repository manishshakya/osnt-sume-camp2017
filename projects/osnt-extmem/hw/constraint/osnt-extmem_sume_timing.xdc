...
#qdr async path
set_false_path -from [get_clocks clk_out1_system_sys_clock_0_0] -to [get_clocks clk_pll_i]
set_false_path -from [get_clocks clk_pll_i] -to [get_clocks clk_out1_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out2_system_sys_clock_0_0] -to [get_clocks clk_pll_i]
set_false_path -from [get_clocks clk_pll_i] -to [get_clocks clk_out2_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out1_system_sys_clock_0_0] -to [get_clocks clk_pll_i_1]
set_false_path -from [get_clocks clk_pll_i_1] -to [get_clocks clk_out1_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out2_system_sys_clock_0_0] -to [get_clocks clk_pll_i_1]
set_false_path -from [get_clocks clk_pll_i_1] -to [get_clocks clk_out2_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out1_system_sys_clock_0_0] -to [get_clocks clk_pll_i_2]
set_false_path -from [get_clocks clk_pll_i_2] -to [get_clocks clk_out1_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out2_system_sys_clock_0_0] -to [get_clocks clk_pll_i_2]
set_false_path -from [get_clocks clk_pll_i_2] -to [get_clocks clk_out2_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out1_system_sys_clock_0_0] -to [get_clocks clk_pll_i_3]
set_false_path -from [get_clocks clk_pll_i_3] -to [get_clocks clk_out1_system_sys_clock_0_0]

set_false_path -from [get_clocks clk_out2_system_sys_clock_0_0] -to [get_clocks clk_pll_i_3]
set_false_path -from [get_clocks clk_pll_i_3] -to [get_clocks clk_out2_system_sys_clock_0_0]
