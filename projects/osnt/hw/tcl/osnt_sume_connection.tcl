...
#connect_bd_net [get_bd_pins osnt_sume_ddr3a_0/ui_clk] [get_bd_pins axi_interconnect_0/M11_ACLK] 
connect_bd_net [get_bd_pins sys_clock_0/clk_out2] [get_bd_pins axi_interconnect_0/M12_ACLK] 
#connect_bd_net [get_bd_pins osnt_sume_ddr3b_0/ui_clk] [get_bd_pins axi_interconnect_0/M12_ACLK] 
connect_bd_net [get_bd_pins sys_clock_0/clk_out2] [get_bd_pins axi_interconnect_0/M13_ACLK] 
#connect_bd_net [get_bd_pins osnt_sume_qdrc_0/clk] [get_bd_pins axi_interconnect_0/M13_ACLK] 
connect_bd_net [get_bd_pins sys_clock_0/clk_out2] [get_bd_pins axi_interconnect_0/M14_ACLK] 
#connect_bd_net [get_bd_pins osnt_sume_qdra_0/clk] [get_bd_pins axi_interconnect_0/M14_ACLK] 
...
#connect_bd_net [get_bd_pins sys_clock_0/clk_out2] [get_bd_pins osnt_sume_nic_output_port_lookup_1/axis_aclk]
...
#connect_bd_net [get_bd_pins osnt_sume_ddr3a_0/rstn] [get_bd_pins axi_interconnect_0/M11_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M12_ARESETN]
#connect_bd_net [get_bd_pins osnt_sume_ddr3b_0/rstn] [get_bd_pins axi_interconnect_0/M12_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M13_ARESETN]
#connect_bd_net [get_bd_pins osnt_sume_qdrc_0/rstn] [get_bd_pins axi_interconnect_0/M13_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/M14_ARESETN]
#connect_bd_net [get_bd_pins osnt_sume_qdra_0/rstn] [get_bd_pins axi_interconnect_0/M14_ARESETN]
...
#connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins osnt_sume_nic_output_port_lookup_1/axis_aresetn] 
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins osnt_sume_bram_pcap_replay_uengine_0/s_axi]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M11_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] 
#connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M11_AXI] [get_bd_intf_pins osnt_sume_ddr3a_0/S_AXI] 
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M12_AXI] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI] 
#connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M12_AXI] [get_bd_intf_pins osnt_sume_ddr3b_0/S_AXI] 
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M13_AXI] [get_bd_intf_pins axi_bram_ctrl_2/S_AXI] 
#connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M13_AXI] [get_bd_intf_pins osnt_sume_qdrc_0/S_AXI] 
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M14_AXI] [get_bd_intf_pins axi_bram_ctrl_3/S_AXI] 
#connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M14_AXI] [get_bd_intf_pins osnt_sume_qdra_0/S_AXI] 
...
#connect_bd_net [get_bd_pins osnt_sume_timestamp_0/rx_ts_pos] [get_bd_pins sume_osnt_10g_interface/rx_ts_pos]
#connect_bd_net [get_bd_pins osnt_sume_timestamp_0/tx_ts_pos] [get_bd_pins sume_osnt_10g_interface/tx_ts_pos]
