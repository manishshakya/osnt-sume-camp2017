...
4. Go to the contrib/challenge2017 folder
5. make
6. Other supported commands:
	...
	- make oneport - test the latency of packet sent from (OSNT) port 0 to port 1, without cross traffic
	Other tests are currently not supported
