...
class MainWindow(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, wx.ID_ANY, "OSNT-SUME Monitor", size=(-1,-1))
        self.gui_init()
    ...
    def gui_init(self):
        ...
        stats_panel.SetBackgroundColour('LIGHT BLUE')
        ...
        cutter_timer_panel.SetBackgroundColour('LIGHT BLUE')
    ...
    def refresh_stats(self, event):
        ...
        #time_low = (time_low >> 32) / float(1000000000)
        ...
        #if ((int(time_new%60) == 0 or int(time_new%40) == 0 or int(time_new%20) == 0) and self.time_index < 5000):
        if ((strftime("%S", gmtime()) == '00' or strftime("%S", gmtime()) == '20' or strftime("%S", gmtime()) == '40') and (self.time_index < 5000)):
            time_f.write("Index "+str(self.time_index)+"   FPGA "+str(time_new%60) + "   System " + strftime("%H %M %S", gmtime()) + "\n")
