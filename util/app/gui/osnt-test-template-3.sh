...
# python osnt-tool-cmd.py -ifp0 ../../sample_traces/128.cap -txs0 6 -rxs0 7 -rpn0 10 -lty0
# python osnt-tool-cmd.py -ifp1 ../../sample_traces/128.cap -txs1 6 -rxs1 7 -rpn1 10 -lty1
